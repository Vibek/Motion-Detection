...
namespace naorobot {
     ...
     */
    geometry_msgs::Point rCoordTransform(geometry_msgs::Point aPoint, geometry_msgs::PoseStamped bOrigin);// need to think, where i need to add instead of Geometry_msgs, there should be something else
